...
def purged_walk_forward_split(
    ...
    *,
    ...
    المعاملات:
        ...
        label_horizon: أفق الهدف بوحدات العيّنات؛ تزال أي عيّنة تدريبية يصل هدفها
            الأمامي إلى كتلة الاختبار.
    ...
    for k in range(1, n_splits + 1):
        ...
        sample_gap = max(purge_samples, label_horizon)
        if sample_gap > 0 and test_idx.size > 0:
            index_cutoff = int(test_idx.min()) - sample_gap
